...
7. Return the DCR response: `client_id`, optional `client_secret`, `client_id_issued_at`, `client_secret_expires_at=0`, `registration_access_token`, `registration_client_uri=<Limen>/t/{slug}/oauth/register/{client_id}`.
