...
| 8   | [Per-tenant, per-user upstream injection](phase-08-per-tenant-injection.md)                                    | 6, 7                    | 🔶 (77%)     |
| 8b  | [Codemode async tool calls (event loop + Promise proxies)](phase-08b-codemode-async-tool-calls.md)             | 8                       | ✅           |
| 8c  | [Ambient context + alias autodiscovery + empty-filter hints](phase-15-ambient-context-and-alias-discovery.md)  | 8                       | 🔶 (87%)     |
...
- [x] `compose.dev.yaml` defines `postgres`, `postgres-zitadel`, `zitadel`, `zitadel-bootstrap`, `mailpit` with healthchecks
...
- [x] `docs/development.md` explains the first-run flow (Mailpit UI included)
