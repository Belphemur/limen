...
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `Tenant`                 | `Slug` (unique), `Name`, `ZitadelOrgID` (unique), `DCREnabled bool`                                                                                       | Root multi-tenancy entity. `PublicID` prefix `tnt_`. `ZitadelOrgID` binds the tenant to a Zitadel organization (Phase 4). Slug reserved-checked.                                                                                                                                                                         |
