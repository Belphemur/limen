  ...
  <div class="flex min-h-screen flex-col bg-bg-main text-on-surface">
    ...
    >
      <div class="mx-auto flex h-portal-header max-w-6xl items-center justify-between px-4">
        <RouterLink
          to="/"
          class="flex items-center gap-2 font-display text-lg font-semibold tracking-tight"
        >
          <span
            class="inline-flex h-7 w-7 items-center justify-center rounded-md bg-primary font-display text-on-primary"
            aria-hidden="true"
          >
            L
          </span>
