...
import { PASSWORD_MIN_SCORE, usePasswordStrength } from '@/composables/usePasswordStrength'
...
const SCORE_COLOR = ['bg-danger', 'bg-danger', 'bg-warning', 'bg-success', 'bg-success'] as const
